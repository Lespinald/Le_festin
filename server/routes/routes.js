...
const { getRecetas, getRecetasById , getRecetasbyIngredientes, createRecetas, getRecetasByIdUsuario} = require('../controllers/recetasController');
...
const { postFavoritos, verificarFavoritos, deleteFavoritos } = require ('../controllers/favoritosController')
